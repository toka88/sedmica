...
/**
 * Razred Igrac predstavlja sadrzi sve potrebne podatke o igracu za SERVER
 * @author Martin
 *
 */
public class Igrac  implements Serializable {
	/** Serijal UID */
	private static final long serialVersionUID = 2417875871177635908L;
	...
	@Override
	/** Vraï¿½a imeKorisnika$kljuï¿½Korisnika*/
